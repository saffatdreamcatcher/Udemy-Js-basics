...
let hour = 11;
if (hour >= 6 && hour < 10) console.log("morning");
...
function areEqual(address11, address12) {
  return (
    address11.street === address12.street &&
...
console.log(numbers2.indexOf(2) !== -1); //if true then the element is present in the array
...
function except(array, excluded) {
  ...
  for (let element of array)
    if (!excluded.includes(element)) output2.push(element);
  return output2;
}
